...
top:
---
 **欢迎使用Git工具进行项目管理, 下面是我整理的常用 Git 命令清单。**
...
# 五、分支
 ...
 > `git checkout -b Hailin/leetcode：` : 新建一个在“Hailin”目录下的“leetcode”分支，并切换到其上
  ![这里写图片描述](https://img-blog.csdn.net/20180312111635714?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvdTAxMDQxMjg1OA==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
 ...
 ![这里写图片描述](https://img-blog.csdn.net/20180312111754710?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvdTAxMDQxMjg1OA==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
